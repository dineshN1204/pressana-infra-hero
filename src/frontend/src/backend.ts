...
export class Backend implements backendInterface {
    ...
    async getAllSubmissions(): Promise<Array<VisitSubmission>> {
    ...
    async getSubmission(arg0: bigint): Promise<VisitSubmission> {
        if (this.processError) {
            try {
    ...
    async submitVisit(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.submitVisit(arg0, arg1, arg2, arg3, arg4, arg5);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
